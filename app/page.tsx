...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="hero relative flex flex-none flex-nowrap flex-col items-center justify-start gap-[56px] z-5 w-full h-[780px] overflow-hidden bg-[var(--background)]">
        {/* HERO TITLE WRAP */}
        <div className="title-wrap mt-12 md:mt-16">
          <div className="title text-center">
            {/* <div className="title-welcome"><p className="text-black">Welcome to Hope Autos Car 😊</p></div> */}
            ...
            <p className="text-lg/6 md:text-xl/8 mb-5 text-color">Your trusted partner in finding the perfect vehicle. We offer quality cars, exceptional service, and competitive prices.</p>
          </div>
          {/* <h1 className="text-5xl/10 md:text-6xl font-bold mb-6">Find your perfect Car. Buy</h1> */}
          {/* <h1 className="text-5xl text-[var(--primary)] md:text-6xl font-bold mb-6"></h1> */}
          {/* <p className="text-lg md:text-xl mb-8 text-color">We deal in Quality vehicles, exceptional service, and unbeatable prices, Browse our curated collection of top-rated vehicles—each offering comfort, safety, and style.</p> */}
          <div className="hero-btn flex items-center justify-center gap-4 md:gap-6">
            <CustomButton 
      ...
      {/* CTA Section */}
      <section className="py-16 bg-emerald-600 text-[#000]">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-x-4">
            <Button size="lg" variant="secondary" className="btn1 cursor-pointer">
              <Link href="/contact">Contact Us</Link>
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="btn2 text-white border-white hover:!bg-white hover:text-blue-600 bg-transparent px-7 cursor-pointer"
            >
