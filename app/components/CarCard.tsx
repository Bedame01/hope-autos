...
export default function CarCard({ car }: CarCardProps) {
  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow">
      <div className="relative h-48 w-[95%] mx-auto rounded-lg shadow-lg overflow-hidden">
        <Image
      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm text-[var(--text-color)] mb-4">
        ...
        {car.description && <p className="text-[var(--text-color)] text-sm mb-4 line-clamp-2">{car.description}</p>}

        <div className="flex space-x-2">
          <Button asChild className="flex-1 btn1">
